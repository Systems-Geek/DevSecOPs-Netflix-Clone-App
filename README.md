This project demonstrates how to deploy a Netflix clone web application on local machine running ubuntu server using modern DevSecOps tools (Inspired by the project build by Nasiullah, Ref: https://github.com/N4si/DevSecOps-Project). The setup includes Docker and Kubernetes files for containarization and auto-scaling, static and dynamic security analysis using Trivy and Sonarqube, CI/CD with Jenkins, and observability with Prometheus and Grafana.
